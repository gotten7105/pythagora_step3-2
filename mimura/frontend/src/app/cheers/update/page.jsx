...
export default function Myparty2() {
    ...
    const handleEventTimeChange = async () => {
        var event_time = time.current.value
        console.log(event_time);

        // if (event_date != "" && event_time != "" ) {
        if (event_date != "" && event_time.length >= 4 ) {            
            ...
            if (response.ok) {
                ...
                router.push(`/cheers/update2?event_id=${event_id}`);
                // alert("Check")
            }
        }
    };
