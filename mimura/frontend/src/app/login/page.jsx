...
//                         <p>メールアドレス:<input type="email" name="email" placeholder="sample@mail.com" className="input input-bordered" /></p>
//                         <p>パスワード:<input type="password" name="password" placeholder="password123" className="input input-bordered" /></p>
//                     </div>
